...
1. [Formatting problems](02-common-mistakes.html)
1. [Dates as data](03-dates-as-data.html)
1. [Exporting data from spreadsheets.](05-exporting-data.html)
1. [Data export formats caveats](06-data-formats-caveats.html)
